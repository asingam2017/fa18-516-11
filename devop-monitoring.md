# DevOp - Continuous Development and Improvements hand: fa18-516-11
 
| Murali Cheruvu
| mcheruvu@iu.edu
| Indiana University
| hid: fa18-516-11
| github: [:cloud:](https://github.com/cloudmesh-community/fa18-516-11/blob/master/topic/paper.md)
  
---
 
Keywords: Cloud, CI, CD, Continuous Monitoring, DevOps
...
Cloud companies aware of this necessity, provide various Dev-Op tools to make CI/CD and continuous monitoring as easy as possible. While, some of these tools and aspects are provided by the cloud offerings, some of them must be planned and planted into our software.

## Continuous Development and Improvement Pipeline
...
1.	Continuous Development: Plan, Code, Build and Test
2.	Continuous Improvement: Deploy, Operate and Monitor

Step 1: Planning, Coding, building the deployable artifacts – code, configuration, database, etc. 
...
Step 2: Once deployed to production, how these applications get operated – bug and health-checks, performance and 
